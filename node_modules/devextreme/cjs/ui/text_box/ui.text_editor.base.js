...
const TextEditorBase = _editor.default.inherit({
    ...
    _setFieldAria(force) {
        ...
        const placeholderId = null === (_this$_$placeholder = this._$placeholder) || void 0 === _this$_$placeholder ? void 0 : _this$_$placeholder.attr("id");
        const value = ariaLabel ? void 0 : [labelId, placeholderId].filter(Boolean).join(" ");
        if (value || force) {
            const aria = {
