...
const View = ModuleItem.inherit({
    ...
    updateBorderedViews() {
        const oldFirstBorderedElement = this.getViewElementWithClass("dx-bordered-top-view");
        const oldLastBorderedElement = this.getViewElementWithClass("dx-bordered-bottom-view");
        ...
        if (oldFirstBorderedElement && !oldFirstBorderedElement.is(newFirstBorderedElement)) {
            oldFirstBorderedElement.removeClass("dx-bordered-top-view")
        }
        if (oldLastBorderedElement && !oldLastBorderedElement.is(newLastBorderedElement)) {
            oldLastBorderedElement.removeClass("dx-bordered-bottom-view")
        }
        if (!newFirstBorderedElement.hasClass("dx-bordered-top-view")) {
            newFirstBorderedElement.addClass("dx-bordered-top-view")
        }
        if (!newLastBorderedElement.hasClass("dx-bordered-bottom-view")) {
            newLastBorderedElement.addClass("dx-bordered-bottom-view")
        }
    },
    isViewsStateValid() {
        var _a;
        if (this.component._views) {
            ...
            if (!(rowsView && (0, _type.isDefined)(null === (_a = rowsView.element) || void 0 === _a ? void 0 : _a.call(rowsView)))) {
                return false
            }
            const optionalViews = ["columnHeadersView", "footerView", "filterPanelView"].map(viewName => this.getView(viewName)).filter(view => {
                var _a;
                return view && (null === (_a = view.isVisible) || void 0 === _a ? void 0 : _a.call(view))
            });
