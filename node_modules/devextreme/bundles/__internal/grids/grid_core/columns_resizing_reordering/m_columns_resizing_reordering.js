...
let DraggingHeaderViewController = function(_modules$ViewControll3) {
    ...
    _proto8._generatePointsByColumns = function(options) {
        ...
        return _m_utils.default.getPointsByColumns(options.columnElements, point => that._pointCreated(point, options.columns, options.targetDraggingPanel.getName(), options.sourceColumn), options.isVerticalOrientation, options.startColumnIndex)
    };
    ...
    _proto8._pointCreated = function(point, columns, location, sourceColumn) {
        ...
        const otherColumnReorderingDisabled = !(null === targetColumn || void 0 === targetColumn ? void 0 : targetColumn.allowReordering) && !(null === prevColumn || void 0 === prevColumn ? void 0 : prevColumn.allowReordering);
        switch (location) {
            case "columnChooser":
                return true;
            case "headers":
