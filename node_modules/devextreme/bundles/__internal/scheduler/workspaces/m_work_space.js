...
let SchedulerWorkSpace = function(_WidgetObserver) {
    ...
    _proto.renderRWorkSpace = function(componentsToRender) {
        const components = null !== componentsToRender && void 0 !== componentsToRender ? componentsToRender : {
            header: true,
            timePanel: true,
            dateTable: true,
            allDayPanel: true
    ...
    _proto.renderWorkSpace = function() {
        let isGenerateNewViewData = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : true;
        this.cache.clear();
