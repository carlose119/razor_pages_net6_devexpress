...
var View = ModuleItem.inherit({
    ...
    updateBorderedViews() {
        var oldFirstBorderedElement = this.getViewElementWithClass("dx-bordered-top-view");
        var oldLastBorderedElement = this.getViewElementWithClass("dx-bordered-bottom-view");
    ...
    isViewsStateValid() {
        ...
        if (this.component._views) {
            ...
            if (!(rowsView && isDefined(null === (_a = rowsView.element) || void 0 === _a ? void 0 : _a.call(rowsView)))) {
                return false
            }
